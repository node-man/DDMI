...
12. **SCALE TARGETS (MVP-0)**: 500 MD files / ~10,000 chunks. Full indexing < 5 min. Query response < 2 sec. Memory < 1GB RSS indexing/querying (transformers.js ONNX runtime ~740MB baseline).
